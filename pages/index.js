...
const Home = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      <Head>
        <title>Login</title>
        <link rel="icon" href="/htu_logo.png" />
      </Head>
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center bg-slate-50 pb-10 text-center shadow-lg md:px-20">
        <span className="mt-8 text-3xl font-semibold">
          ...
          <h1 className="text-green-700">
            ...
            <p className="font-bold uppercase"> Election System</p>
          </h1>
        </span>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              name="username"
              required
              placeholder="Index number without /"
          ...
          <div>
            <span className="cursor-pointer text-gray-700">
              Don't have OTP? Contact Admin <br />
              <span className="text-sm text-gray-700">On: 000 000 0000</span>
            </span>
          </div>
          {loading ? (
